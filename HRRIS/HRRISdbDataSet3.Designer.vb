...
Partial Public Class HRRISdbDataSet3
    ...
    Partial Public Class invoiceDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddinvoiceRow(ByVal invoice_date As Date, ByVal amount As Integer) As invoiceRow
            Dim rowinvoiceRow As invoiceRow = CType(Me.NewRow,invoiceRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, invoice_date, amount}
...
Namespace HRRISdbDataSet3TableAdapters
    ...
    Partial Public Class invoiceTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `invoice` WHERE ((`booking_id` = ?) AND ((? = 1 AND `invoice_date` IS"& _ 
                " NULL) OR (`invoice_date` = ?)) AND ((? = 1 AND `amount` IS NULL) OR (`amount` ="& _ 
                " ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `invoice` (`invoice_date`, `amount`) VALUES (?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `invoice` SET `invoice_date` = ?, `amount` = ? WHERE ((`booking_id` = ?) A"& _ 
                "ND ((? = 1 AND `invoice_date` IS NULL) OR (`invoice_date` = ?)) AND ((? = 1 AND "& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT booking_id, invoice_date, amount FROM invoice"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As HRRISdbDataSet3.invoiceDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As HRRISdbDataSet3.invoiceDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As HRRISdbDataSet3.invoiceDataTable = New HRRISdbDataSet3.invoiceDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As HRRISdbDataSet3.invoiceDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_booking_id As Integer, ByVal Original_invoice_date As Date, ByVal Original_amount As Integer) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_booking_id,Integer)
            Me.Adapter.DeleteCommand.Parameters(1).Value = CType(0,Object)
            Me.Adapter.DeleteCommand.Parameters(2).Value = CType(Original_invoice_date,Date)
        ...
        Public Overloads Overridable Function Insert(ByVal invoice_date As Date, ByVal amount As Integer) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(invoice_date,Date)
        ...
        Public Overloads Overridable Function Update(ByVal invoice_date As Date, ByVal amount As Integer, ByVal Original_booking_id As Integer, ByVal Original_invoice_date As Date, ByVal Original_amount As Integer) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(invoice_date,Date)
            ...
            Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_invoice_date,Date)
